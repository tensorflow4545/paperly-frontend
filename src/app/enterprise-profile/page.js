  ...
  const handleNavItemClick = (item) => {
    ...
    switch (item) {
      case "home":
        ...
        break
      case "workspace":
        // TODO: Navigate to workspace when ready
        console.log("Workspace navigation not yet implemented")
        break
      case "dashboard":
        // TODO: Navigate to dashboard when ready
        console.log("Dashboard navigation not yet implemented")
        break
      case "edit-profile":
        // Already on edit profile page, do nothing
        break
      case "logout":
        logout()
        break
