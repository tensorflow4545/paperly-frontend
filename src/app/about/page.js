        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          >
            ...
            >
              ...
              <span className="font-semibold">About Paprly</span>
            </motion.div>
          ...
          >
            <motion.div 
              className="bg-gray-100 p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300"
              whileHover={{ 
                scale: 1.02,
                y: -5,
              }}
            ...
            >
              <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center mb-4">
                <svg className="w-6 h-6" fill="none" stroke="#e3b854" viewBox="0 0 24 24" style={{ color: '#e3b854' }}>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                   ...
                   <svg className="w-5 h-5" fill="none" stroke="#e3b854" viewBox="0 0 24 24" style={{ color: '#e3b854' }}>
                ...
                <ul className="space-y-4">
                   ...
                   >
                     <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="#e3b854" viewBox="0 0 20 20" style={{ color: '#e3b854' }}>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-xl">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Upcoming Features</h3>
                   ...
                   <div className="flex items-center gap-3">
                     <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#e3b854' }}></div>
          ...
          >
                         <motion.div 
               className="bg-transparent p-6 rounded-2xl border border-[2px] border-gray-300"
             ...
             >
               ...
               <p className="text-sm text-gray-600">Generate and share documents in seconds, not minutes</p>
                         ...
                         <motion.div 
               className="bg-transparent p-6 rounded-2xl border border-[2px] border-gray-300 sm:col-span-2 lg:col-span-1"
               whileHover={{ scale: 1.02, y: -3 }}
               transition={{ type: "spring", stiffness: 300 }}
             >
               <div className="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center mb-4">
