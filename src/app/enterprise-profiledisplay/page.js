...
export default function ProfilePage() {
  const [activeNavItem, setActiveNavItem] = useState("edit-profile")
          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8">
            <div className="w-full space-y-4 sm:space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
                      />
                      <svg
                ...
                {/* Company Logo Upload */}
                <div className="flex flex-col items-center py-8 sm:py-12 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
                  <svg
                  ...
                  <p className="text-gray-600 mb-4 text-center text-sm sm:text-base px-4">
                    Drag & drop your company logo here, or browse
                  </p>
                  <button className="bg-white border border-gray-300 text-gray-700 px-4 sm:px-6 py-2 rounded-md hover:bg-gray-50 transition-colors text-sm sm:text-base">
                    Browse Files
                  </button>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange("gstinTaxId", e.target.value)}
                      className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => handleToggle("onboardingKit")}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => handleToggle("timestampProof")}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                  ...
                  <div className="max-w-full sm:max-w-md">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => handleInputChange("defaultSignatureStyle", e.target.value)}
                        className="w-full px-4 py-3 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
                      />
                      <svg
                        className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400"
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                <button className="px-4 sm:px-6 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors text-sm sm:text-base order-3 sm:order-1">
                  Cancel & Exit
                </button>
                <button className="px-4 sm:px-6 py-2 bg-purple-800 hover:bg-purple-900 text-white font-medium rounded-md transition-colors text-sm sm:text-base order-2">
                  Save Profile
                </button>
                <button className="px-4 sm:px-6 py-2 bg-[#D4AF37] hover:bg-[#B8941F] text-gray-900 font-medium rounded-md transition-colors text-sm sm:text-base order-1 sm:order-3">
